...
//	public Usuario(String nome, String sobrenome, Instant data_admissao, Instant data_demissao,
...
//		this.legibilidade = (legibilidade==null) ? new Legibilidade(0) : legibilidade;
//	}
	public Usuario() {
		super();
	}
